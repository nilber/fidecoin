Fidecoin Core version *0.15.1* is now available from:

  <https://download.fidecoin.org/fidecoin-0.15.1/>
...
A number of changes to the way Fidecoin Core deals with peer connections and invalid blocks
...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 fides per kB (0.00001 FIDE). This is to prepare for dropping the minimum transaction fee to 0.1 fides per kB (0.0001 FIDE) in the next release.
