# Support for Output Descriptors in Fidecoin Core

Since Fidecoin Core v0.17, there is support for Output Descriptors. This is a
...
on Fidecoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Fidecoin Core wallets, a convenience function `combo` is
