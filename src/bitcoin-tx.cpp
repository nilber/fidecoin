...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " fidecoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  fidecoin-tx [options] <hex-tx> [commands]  Update hex-encoded fidecoin transaction\n" +
            "or:     fidecoin-tx [options] -create [commands]   Create hex-encoded fidecoin transaction\n" +
            "\n";
