...
{
    const char* pszTimestamp = "Nb 09 jan 2021";
...
public:
    CMainParams() {
        ...
        consensus.BIP34Hash = uint256S("1b338aed1e24c81140504644458a1c225b1945185e55129e712d5bb6dfc1c37c");
        ...
        genesis = CreateGenesisBlock(1317972665, 979680, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x1b338aed1e24c81140504644458a1c225b1945185e55129e712d5bb6dfc1c37c"));
        assert(genesis.hashMerkleRoot == uint256S("0xa2c74ed3c51d6735af6fa60253b99515dca6e96493fd992aa0d2fd4ca7bf8e95"));
        ...
        checkpointData = {{{0, uint256S("0x1b338aed1e24c81140504644458a1c225b1945185e55129e712d5bb6dfc1c37c")},}};
...
public:
    CTestNetParams() {
        ...
        consensus.BIP34Height = 1;
        consensus.BIP34Hash = uint256S("0d6e9c793c30073db4d38a3e86bee9fc8f2ab92175e2361bd1f2c84a3978263d");
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x0d6e9c793c30073db4d38a3e86bee9fc8f2ab92175e2361bd1f2c84a3978263d"); //1174621
        ...
        genesis = CreateGenesisBlock(1317972600, 1, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x0d6e9c793c30073db4d38a3e86bee9fc8f2ab92175e2361bd1f2c84a3978263d"));
        assert(genesis.hashMerkleRoot == uint256S("0xa2c74ed3c51d6735af6fa60253b99515dca6e96493fd992aa0d2fd4ca7bf8e95"));
        ...
        checkpointData = {
            {
                {0, uint256S("0d6e9c793c30073db4d38a3e86bee9fc8f2ab92175e2361bd1f2c84a3978263d")},
            }
        };
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x109a6687e79924eb18bbca983edf711c74b34840f90601950b45d7319ad4316e"));
        assert(genesis.hashMerkleRoot == uint256S("0xa2c74ed3c51d6735af6fa60253b99515dca6e96493fd992aa0d2fd4ca7bf8e95"));
        ...
        checkpointData = {
            {
                {0, uint256S("109a6687e79924eb18bbca983edf711c74b34840f90601950b45d7319ad4316e")},
            }
        };
