...
"""Verify that starting fidecoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start fidecoin with -h for help text")
        ...
        self.log.info("Start fidecoin with -version for version information")
        ...
        self.log.info("Start fidecoind with -fakearg to make sure it does not start")
